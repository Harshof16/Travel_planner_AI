...
Holiday Triangle Travel Private Limited (â€œwe/ us/ our/ ENFâ€) values the trust which a customer (â€œyou/ yourâ€) places in ENF and our website,ESCAPENFLY.com (â€œWebsiteâ€). Hence, we insist upon the highest standard of practices to ensure security of transactions and utmost privacy of customer information. We respect your need to understand how information furnished by you is being collected, used, disclosed, transferred and stored by us. In this regard, please read this privacy policy (â€œPolicyâ€) to get familiarized about our information gathering and dissemination practice.

 

We assure you of our firm commitment to your privacy and the protection of your priceless information. The Policy contains information about the Website and the 'Travel Triangle' android and iOS app (such applications are collectively referred as the â€œAppâ€). In order to endow you with the uninterrupted use of our services, we may collect and, in some circumstances, disclose information about you.

If you do not agree to the terms in this Policy, we kindly ask you to leave the site.

 

If you have any questions or concerns, regarding this privacy policy, you should contact our Customer Support Desk at enf@escapenfly.com
...
We collect and use your personal information when you avail our services. For the purpose of the General Data Protection Regulation (â€œGDPRâ€), we are the â€˜data controllerâ€™. Our data protection officer can be contacted at dpo@ESCAPENFLY.com.
...
8.    Notifications of modifications and changes to the policy

9.    Sharing of travelerâ€™s photos and videos

10.  Security precautions

11.  Choice to opt out

12.  Advertisement on website
...
1.    We collect your personally identifiable information including but not limited to your (i) name; (ii) e-mail address; (iii) contact number; (iv) residential address; (v) credit/debit/bank account details; (vi) internet protocol (â€œIPâ€) address, in the following circumstances:

2.    When you make a reservation, or opt for a package from our Website or App or through the aid of our customer service team;

3.    When you register with us, make a requisition for information pertaining to holiday packages, subscribe to our enter competitions, share with us your experience or provide any other details in relation to a holiday package availed by you, send us queries or register for promotions;

4.    When you set up a free account on our Website or App or participate in surveys or provide us your feedback; and

5.    When you engage with us in any online or offline event or portray your interest on any page hosted by us on a third-party platform or location or voluntarily provide your details for our promotions.

6.    While you can browse certain sections of our Website or App, prior to registering as a member, certain activities (such as placing an order) requires mandatory registration1. We may use your contact information for sending you (i) offers based on your previous orders and your interests, (ii) payment reminder notices, (iii) travel vouchers and (iv) updates on the travel sector through our newsletters. In the event, you do not wish to receive such information, you may unsubscribe through the facility in the email message you receive.

 

2. How we use personal data

We use personal information to provide the services that you request. To the extent we use your information including personal information to market our services to you, we will provide you the ability to opt-out of such uses.
...
1.    help detect and prevent identity theft,

2.    fraud and other potentially illegal acts;

3.    co-relate related or multiple accounts to prevent abuse of our services;

4.    to facilitate joint or co-branded services that you request where such services are provided by more than one corporate entity.
...
ENF takes the protection of your Customer Data seriously but, unfortunately, the transmission of information via the internet is not completely secure. Although we will do our best to protect your Customer Data, we cannot guarantee the security of your Customer Data transmit ENF ed through any channel, such as the Website; any transmission is at your own risk.

 

8. Notification of Modifications and Changes to the Policy
...
9. Sharing of travelersâ€™ photos and videos

By voluntarily submitting your travel photos or videos to ENF after availing our services, either on our Website or App or through email or any other medium of communication to us, you grant to ENF, a non-exclusive, perpetual, worldwide, royalty-free, transferable, and sub-licensable, license to edit, telecast, re-run, reproduce, use, syndicate, print and distribute the materials you submit, or any portion thereof, in or in connection with ENF and any of its affiliatesâ€™ websites, programming, platforms and/or App (the manner, mode and extent of which are subject to change without notice to you), in any manner, and in any medium or forum. You represent and warrant to ENF that you have the full legal right, power and authority to grant the aforementioned license to ENF. You further agree that your submission(s), and the exercise of the rights granted herein, pursuant to the aforesaid terms, do not and will not violate any applicable laws or regulations, or cause a breach of any agreement(s) entered by you with any third parties, and that none of the submission(s) will infringe any copyright, invade any right of privacy, right of publicity, contain any libelous or slanderous material, or infringe or violate any other intellectual property right or other right (including common law rights) of any other person or entity.
...
ENFâ€™s Corporate Office is based in Gurgaon, Haryana, India. It is the place from where it carries its operations. Accordingly, Customer Data will be accessible to ENFâ€™s offices and appointed agents based out of India. This means that Customer Data will be transferred to, and stored at, a destination outside of your country and outside the European Economic Area ("EEA"). If you are an EU resident, and we transfer Customer Data outside the EEA, this is done on the basis that it is necessary in discharge of the services rendered to you by ENF or its agents.

14. EU data subject rights

If you are a resident in the EU, you may have certain rights in relation to the Customer Data we hold about you, which we detail below. Some of these only apply in certain circumstances where ENF is holding authority of the data and legally/contractually allowed as per the local laws as set out in more detail below. We also set out how to exercise those rights.

1.    Right to information - including contact details to the DPO, the purposes for processing Personal Information and the rights of the individual.

2.    Right to access the Personal Information that are processed

3.    Right to erasure (â€ Right to be forgottenâ€)

4.    Right to rectification

5.    Right to restriction of processing

6.    Right to data portability of the Personal Information supplied to ENF by the EU resident

7.    Right to object (opt-out) to processing (unless ENF otherwise has compelling legitimate grounds)

EU residents can exercise these rights by raising a request directly at dpo@ESCAPENFLY.com .
...
Email: abhisheksharma@escapenfly.com
`;
